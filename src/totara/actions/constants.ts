...
const SETUP_HOST = "SETUP_HOST";

export { TOKEN_SENT, UPDATE_COUNT, UPDATE_TOKEN, ADD_RESOURCE, UPDATE_RESOURCE, DELETE_RESOURCE, PURGE, SETUP_HOST, INIT_SESSION, END_SESSION };
