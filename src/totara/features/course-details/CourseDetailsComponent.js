        ...
        <View style={styles.activitiesContainer}>
          <View style={styles.tabNav}>
            <TouchableOpacity
              ...
              onPress={() => this.setShowAcitivities(true)}
            >
              <Text
                style={
                  this.state.showActivities
            ...
            <TouchableOpacity
              ...
              onPress={() => this.setShowAcitivities(false)}
            >
              <Text
                style={
                  !this.state.showActivities
              ...
              >
                {translate("course-details.outline")}
              </Text>
            </TouchableOpacity>
          </View>
          {this.state.showActivities ? (
            <ActivityList
              activityGroups={item.sections}
              onScroll={this.onScroll}
            />
          ) : (
            <Text>{translate("course-details.outline")}</Text>
          )}
        </View>
      </View>
    );
