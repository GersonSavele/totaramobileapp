...
import { coreCertification, coreProgram, mutationReportProgramme } from './index';
...
export { certificationMock, course, courseSetListMock, courseSetMock, mockEmpty, mockError, programMock };
