...
const defaultConfig = {
  ...
  nativeLoginSetupUri: "https://mobile.demo.totara.software/totara/mobile/login_setup.php",
  nativeLoginUri: "https://mobile.demo.totara.software/totara/mobile/login.php",
