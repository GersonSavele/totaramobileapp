...
function SCORMapi1_2(
  ...
  for (itemScoid in def) {
    datamodel[itemScoid] = {
      ...
      "cmi.core.lesson_location": {
        defaultvalue: def[itemScoid]["cmi.core.lesson_location"],
        format: CMIString256,
        mod: "rw",
        writeerror: "405"
      },
      ...
      "cmi.core.lesson_status": {
        defaultvalue: def[itemScoid]["cmi.core.lesson_status"],
        format: CMIStatus,
        mod: "rw",
        writeerror: "405"
      },
      ...
      "cmi.core.score.raw": {
        defaultvalue: def[itemScoid]["cmi.core.score.raw"],
        format: CMIDecimal,
        range: score_range,
        mod: "rw",
        writeerror: "405"
      ...
      "cmi.core.score.max": {
        defaultvalue: def[itemScoid]["cmi.core.score.max"],
        format: CMIDecimal,
        range: score_range,
        mod: "rw",
        writeerror: "405"
      ...
      "cmi.core.score.min": {
        defaultvalue: def[itemScoid]["cmi.core.score.min"],
        format: CMIDecimal,
        range: score_range,
        mod: "rw",
        writeerror: "405"
      ...
      "cmi.core.exit": {
        defaultvalue: def[itemScoid]["cmi.core.exit"],
        format: CMIExit,
        mod: "w",
        readerror: "404",
        writeerror: "405"
      ...
      "cmi.suspend_data": {
        defaultvalue: def[itemScoid]["cmi.suspend_data"],
      ...
      "cmi.comments": {
        defaultvalue: def[itemScoid]["cmi.comments"],
        format: CMIString4096,
        mod: "rw",
        writeerror: "405"
      },
      ...
      "cmi.student_data.mastery_score": {
        defaultvalue: def[itemScoid]["cmi.student_data.mastery_score"],
        mod: "r",
        writeerror: "403"
      },
      "cmi.student_data.max_time_allowed": {
        defaultvalue: def[itemScoid]["cmi.student_data.max_time_allowed"],
        mod: "r",
        writeerror: "403"
      },
      "cmi.student_data.time_limit_action": {
        defaultvalue: def[itemScoid]["cmi.student_data.time_limit_action"],
        mod: "r",
        writeerror: "403"
      },
      "cmi.student_preference._children": { defaultvalue: student_preference_children, mod: "r", writeerror: "402" },
      "cmi.student_preference.audio": {
        defaultvalue: def[itemScoid]["cmi.student_preference.audio"],
        format: CMISInteger,
        range: audio_range,
        mod: "rw",
        writeerror: "405"
      ...
      "cmi.student_preference.language": {
        defaultvalue: def[itemScoid]["cmi.student_preference.language"],
        format: CMIString256,
        mod: "rw",
        writeerror: "405"
      },
      "cmi.student_preference.speed": {
        defaultvalue: def[itemScoid]["cmi.student_preference.speed"],
        format: CMISInteger,
        range: speed_range,
        mod: "rw",
        writeerror: "405"
      ...
      "cmi.student_preference.text": {
        defaultvalue: def[itemScoid]["cmi.student_preference.text"],
        format: CMISInteger,
        range: text_range,
        mod: "rw",
        writeerror: "405"
  ...
  function LMSInitialize(param) {
    ...
    if (oldcmi == "null")
      // TODO don't use null string
      initdatamodel(scoid);
    else cmi = JSON.parse(oldcmi);
  ...
  function StoreData(data, storetotaltime) {
    if (storetotaltime) {
      ...
      if (cmi.core.lesson_mode == "browse") {
        if (
          datamodel[scoid]["cmi.core.lesson_status"].defaultvalue == "" &&
          cmi.core.lesson_status == "not attempted"
        ) {
